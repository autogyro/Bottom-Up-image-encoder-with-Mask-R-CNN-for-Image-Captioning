...
class SigmoidCrossEntropyLossHongyuanLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyLossHongyuanLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SigmoidCrossEntropyLossHongyuan"; }
